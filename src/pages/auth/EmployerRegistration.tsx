      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 mt-2">
            Access the top 5% of global tech talent for your projects
          </p>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      {getErrorMessage(errors.jobTitle) && (
                        <p className="text-red-500 text-sm mt-1">{getErrorMessage(errors.jobTitle)}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    {getErrorMessage(errors.confirmPassword) && (
                      <p className="text-red-500 text-sm mt-1">{getErrorMessage(errors.confirmPassword)}</p>
                    )}
                  </div>
                </div>
              )}
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    {getErrorMessage(errors.companyName) && (
                      <p className="text-red-500 text-sm mt-1">{getErrorMessage(errors.companyName)}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {getErrorMessage(errors.website) && (
                      <p className="text-red-500 text-sm mt-1">{getErrorMessage(errors.website)}</p>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      {getErrorMessage(errors.location) && (
                        <p className="text-red-500 text-sm mt-1">{getErrorMessage(errors.location)}</p>
                      )}
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {getErrorMessage(errors.termsAccepted) && (
                      <p className="text-red-500 text-sm">{getErrorMessage(errors.termsAccepted)}</p>
                    )}
