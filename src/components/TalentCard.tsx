      ...
      <div className="flex items-start space-x-4">
        ...
        <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center space-x-1 mb-1">
                <div className="flex text-yellow-400">
                  {[...Array(5)].map((_, i) => (
                    <i
                      key={i}
                      className={`fas fa-star text-xs ${i < Math.floor(talent.rating) ? "text-yellow-400" : "text-slate-300"
                        }`}
                    ></i>
                  ))}
                </div>
          ...
          <div className="mt-3 flex items-center space-x-2">
            <div className={`w-2 h-2 rounded-full ${talent.availability === "Available Now"
                ? "bg-green-500"
                : "bg-yellow-500"
              }`}></div>
